...
pkgdatadir = $(datadir)/mybot
pkgincludedir = $(includedir)/mybot
pkglibdir = $(libdir)/mybot
pkglibexecdir = $(libexecdir)/mybot
...
am__v_CCLD_1 = 
SOURCES = $(mybot_SOURCES)
DIST_SOURCES = $(mybot_SOURCES)
...
mybot$(EXEEXT): $(mybot_OBJECTS) $(mybot_DEPENDENCIES) $(EXTRA_mybot_DEPENDENCIES) 
	@rm -f mybot$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(mybot_OBJECTS) $(mybot_LDADD) $(LIBS)
